...
class D3Chart extends Component {
    on_create() {
        ...
        let chart_dom_element = this.chart_dom_element = this.tools.extra.parse_html(`<div id="chart"></div>`)
        this.tools.extra.add_css(`
            #chart {
                position: absolute;
                top: 0;
                left: 0;
        ...
        chart_dom_element.appendChild(chart)
