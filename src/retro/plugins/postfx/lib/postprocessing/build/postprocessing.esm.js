...
// src/retro/Disposable.js
var Disposable = class {
  dispose() {
  }
};

// src/retro/EffectComposer.js
import {
  DepthStencilFormat,
  DepthTexture,
...
// src/retro/OverrideMaterialManager.js
...
// src/retro/Initializable.js
var Initializable = class {
  initialize(renderer, alpha, frameBufferType) {
  }
};

// src/retro/Resizable.js
var Resizable = class {
  setSize(width, height) {
  }
};

// src/retro/Selection.js
...
var SSAOEffect = class extends Effect {
  constructor(camera, normalBuffer, {
    ...
    this.ssaoPass = new ShaderPass((() => {
      const noiseTexture = new NoiseTexture(NOISE_TEXTURE_SIZE, NOISE_TEXTURE_SIZE, RGBFormat8);
  ...
  setSize(width, height) {
    ...
    uniforms.noiseScale.value.set(w * 2, h * 2).divideScalar(NOISE_TEXTURE_SIZE);
