var spine = (() => {
  ...
  // spine-retro/src/attachments/Attachment.ts
  ...
  // spine-retro/src/AnimationState.ts
  ...
  // spine-retro/src/AnimationStateData.ts
  ...
  // spine-retro/src/attachments/BoundingBoxAttachment.ts
  ...
  // spine-retro/src/attachments/ClippingAttachment.ts
  ...
  // spine-retro/src/TextureAtlas.ts
  ...
  // spine-retro/src/attachments/MeshAttachment.ts
  ...
  // spine-retro/src/attachments/PathAttachment.ts
  ...
  // spine-retro/src/attachments/PointAttachment.ts
  ...
  // spine-retro/src/attachments/RegionAttachment.ts
  ...
  // spine-retro/src/AtlasAttachmentLoader.ts
    ...
    updateWorldTransformWith(x, y, rotation, scaleX, scaleY, shearX, shearY) {
      ...
      switch (this.data.transformMode) {
        case TransformMode.Normal: {
          ...
          // console.log("updateWorldTransformWith", pa, la, pb, lc, "s", rotation + shearX, MathUtils.cosDeg(rotation + shearX), scaleX)
          this.a = pa * la + pb * lc;
          this.b = pa * lb + pb * ld;
          this.c = pc * la + pd * lc;
          this.d = pc * lb + pd * ld;
  ...
  // spine-retro/src/ConstraintData.ts
  ...
  // spine-retro/src/AssetManagerBase.ts
  ...
  // spine-retro/src/IkConstraint.ts
  ...
  // spine-retro/src/IkConstraintData.ts
  ...
  // spine-retro/src/PathConstraintData.ts
  ...
  // spine-retro/src/PathConstraint.ts
  ...
  // spine-retro/src/TransformConstraint.ts
  ...
  // spine-retro/src/SkeletonData.ts
  ...
  // spine-retro/src/TransformConstraintData.ts
  ...
  // spine-retro/src/SkeletonBinary.ts
  ...
  // spine-retro/src/SkeletonBounds.ts
  ...
  // spine-retro/src/Triangulator.ts
  ...
  // spine-retro/src/SkeletonClipping.ts
  ...
  // spine-retro/src/SkeletonJson.ts
  ...
  function readTimeline22(keys, timeline, name1, name2, defaultValue, scale) {
    ...
    for (let frame = 0; ; frame++) {
      ...
      if (curve && false) {
        ...
        if (curve) {
          curve = [curve, keyMap.c2 || 0, keyMap.c3 || 1, keyMap.c4 || 1]
          bezier = readCurve(curve, timeline, bezier, frame, 0, time, time2, value1, nvalue1, scale);
          bezier = readCurve(curve, timeline, bezier, frame, 0, time, time2, value2, nvalue2, scale);
        } else {
          bezier = readCurve(curve, timeline, bezier, frame, 0, time, time2, value1, nvalue1, scale);
        ...
        console.log(arr_has_nans(timeline.curves), keyMap.curve, timeline, bezier, frame, 0, time, time2, value1, nvalue1, scale)
      }
  ...
  // spine-retro/src/vertexeffects/JitterEffect.ts
  ...
  // spine-retro/src/vertexeffects/SwirlEffect.ts
  ...
  var THREE = __toModule(__require("retro/lib/three/index"));
  ...
  var THREE2 = __toModule(__require("retro/lib/three/index"));
  ...
  var _SkeletonMesh = class extends THREE2.Object3D {
    ...
    nextBatch() {
      if (this.batches.length == this.nextBatchIndex) {
        let batch2 = new MeshBatcher(10920, this.materialCustomizer);
        this.add(batch2);
  ...
  var THREE3 = __toModule(__require("retro/lib/three/index"));
