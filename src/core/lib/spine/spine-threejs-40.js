var spine = (() => {
  ...
  var THREE = __toModule(__require("core/lib/three/index"));
  ...
  var THREE2 = __toModule(__require("core/lib/three/index"));
  ...
  var THREE3 = __toModule(__require("core/lib/three/index"));
