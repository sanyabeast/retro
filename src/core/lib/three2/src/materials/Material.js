...
import { FrontSide, DoubleSide, FlatShading, NormalBlending, LessEqualDepth, AddEquation, OneMinusSrcAlphaFactor, SrcAlphaFactor, AlwaysStencilFunc, KeepStencilOp } from '../constants.js';
	...
	setValues(values) {
		...
		for (const key in values) {
			...
			if (currentValue && currentValue.isColor) {
				...
				if (key === 'uniforms') {
					window.F_THREE_PATCH_UNIFORMS(newValue, this)
				}
				this[key] = newValue;
			}
		}
...
Material.patch_uniforms = function (uniforms) { console.log(`patching uniforms`) }
