    ...
    switch (Device.device_type) {
        ...
        default: {
            ...
            frame.add_button("RNDR", "View Final Render", () => {
                app.refs.renderer.set_service_view_mode("default")
            }, "#9c27b0")
            frame.add_button("NRML", "View Normals", () => {
                app.refs.renderer.set_service_view_mode("normal")
            }, "#7e6ae5")
            frame.add_button("DPTH", "View Depth", () => {
                app.refs.renderer.set_service_view_mode("depth")
            }, "#e91e63")
            frame.add_button("WRFM", "View Wireframe", () => {
                app.refs.renderer.set_service_view_mode("wireframe")
            }, "#fe8dff")
            frame.add_button("MTCP", "View Matcap", () => {
                app.refs.renderer.set_service_view_mode("matcap")
            }, "#e91e1e")
